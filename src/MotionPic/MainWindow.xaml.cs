...
namespace MotionPic
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            InitializeComponent();
            MainGenericVM aViewModel = new MainGenericVM();
            DataContext = aViewModel;
            //AforgePicturBoxXaml = new AForge.Controls.PictureBox();
            //AforgePicturBoxXaml.Image = null;
        }
        /// <summary> 
        /// Dependency property for video device source Id. 
        /// </summary> 
        //public static readonly DependencyProperty VideoSourceDepProperty = DependencyProperty.Register("VideoSourceDepPropertyReg", typeof(string), typeof(AForge.Video.IVideoSource), new PropertyMetadata(string.Empty, VideoSourceIdPropertyChangedCallback, VideoSourceIdPropertyCoherceValueChanged));

        //private static object VideoSourceIdPropertyCoherceValueChanged(DependencyObject d, object baseValue)
        //{
        ...
        private double RADIUS { get; set; } = 150.0;
